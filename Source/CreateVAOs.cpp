...
//  fullscreen quad (pozadina mapa)
float verticesMapRect[] = {
    -1.0f, -1.0f, 0.0f, 0.0f, // bottom-left
...
// wider VAO for standing-man appearance (square-ish)
